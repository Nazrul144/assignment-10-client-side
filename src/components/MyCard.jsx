...
const MyCard = ({ item, items, setItems }) => {
  ...
  return (
    <div>
      <div className="card h-full bg-base-100 shadow-xl duration-1000 ease-in-out hover:bg-violet-200 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300 mt-32 md:mt-4 ">
